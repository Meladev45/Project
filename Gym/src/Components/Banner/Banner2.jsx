    ...
    <div className='container my-14'>
      <div className='bg-[#f9f9f9] py-14 md:py-24 flex justify-center items-center'>
        ...
        <div className='flex flex-col justify-center items-center space-y-8 lg:px-44'>
            ...
            whileInView={'visible'}
            viewport={{once:true}}
            className='text-3xl lg:text-5xl font-bold uppercase'>Get 20% Discount on Your Order, Are you Ready to Buy</motion.h1>
            <motion.p  variants={SlideLeft(0.7)}
            initial='hidden'
            whileInView={'visible'}
            viewport={{once:true}}>we will make sure you get the right and the best quality products for your workout</motion.p>
            <motion.div
